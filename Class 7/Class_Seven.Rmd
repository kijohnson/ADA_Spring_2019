---
title: 'Class Seven: Multinomial and ordinal logistic regression'
author: "Xiaoyan Wang"
date: "Feb 27, 2019"
output:
...
- Breast cancer data was downlaoded from the Surveillance, Epidemiology, and End Results Program (SEER) database, a premier data source for cancer statistics in the US. SEER collects incidence, prevalence and survival data.
- Patients with primary breast cancer, aged between 18-65 years with Stage I to IV at diagnosis were included. 
- In this study, we are interested in the effects of insurance status on stage at diagnosis among breast cancer patients.
...
###Drop the cases who did not have first primary diagnosis of breast cancer and with missing values on any variables used for complete case analysis
...
- The log odds of being diagnosed at stage I vs. stage IV is increased by 1.6 in cases with private insurance compared to those without insurance. 
- The log odds of being diagnosed at stage II vs. stage IV is increased by 0.90 in cases with private insurance compared to those without insurance. 
- The log odds of being diagnosed at stage III vs. stage IV is increased by 0.66 in cases with private insurance compared to those without insurance. 
- For Medicaid compared to private insured?

##Interpretations (con.)

- To know the effect of *Insured* on the logit of a non-refernce outcome relative to another non-refernce outcome (e.g.,stage II vs. stage III)), you can take the difference of the two *coefficients* (0.8995393-0.6633521=0.2361872).
- Meaning: the log odds of being diagnosed in stage II vs. stage III is increased by 0.236 in those with private insurance compared to those without insurance. 
...
##Interpretations
- *Categorical variable*
- The odds of being diagnosed with stage I breast cancer relative to stage IV is 5.07 times greater for privately insured cases versus uninsured cases. 
...
bi_logit <- Complete %>%
  filter(Stage_cat=="StageI"| Stage_cat=="StageIV") %>%
  mutate(Stage_cat_re =relevel(Stage_cat, ref = "StageIV"))
...
exp(confint(mod, level=0.95)[1:3,1:2,1])
```
...
mod_c <- multinom(Stage_cat_re ~ Insur_cat + Age_num + Male_cat + Race_cat)
summary(mod_c)
...
- *Continous variable*
- The odds of being diagnosed with stage I breast cancer relative to stage IV is 1.02 times greater with each one-year increases in age, holding all other variables constant. 
- *Categorical variable*
- The odds of being diagnosed with stage I breast cancer relative to stage IV is 4.44 times greater for privately insured cases versus uninsured cases, holding all other variables constant. 
...
- *Categorical variable*
- The odds of being diagnosed at stage IV are 0.404 times the odds of being diagnosed at *stages III to I* for patients with private insurance than those without insurance at diagnosis.
- *or*
- The odds of being diagnosed at *stage IV and III* are 0.404 times the odds of being diagnosed at *stages II and I* for patients with private insurance than those without insurance at diagnosis. 
- *or*
- The odds of being diagnosed at *stage IV to II* are 0.404 times the odds of being diagnosed at *stages I* for patients with private insurance than those without insurance at diagnosis. 
...
##Interpretations 
- *Categorical variable*
- The odds of being diagnosed at stage I are 2.47 times the odds of being diagnosed at *stages II to IV* for patients with private insurance than those without insurance at diagnosis.
- *or*
- The odds of being diagnosed at *stage I and II* are 2.47 times the odds of being diagnosed at *stages III and IV* for patients with private insurance than those without insurance at diagnosis.
- *or*
- The odds of being diagnosed at *stage I to III* are 2.47 times the odds of being diagnosed at *stages IV* for patients with private insurance than those without insurance at diagnosis. 

##Execute a ordinal logistic regression with potential confounders

```{r, echo=TRUE,  warning=FALSE}
mod1_c <- polr(Stage_cat ~ Insur_cat + Age_num + Male_cat + Race_cat, Hess=TRUE)
## odds ratios and 95%CIs
...
- Examples
- *Continous variable*
- The odds of being diagnosed at *stage IV* is 0.973 times the Odds of being diagnosed at *stages I to III* with each one-year increases in age, holding all other variables constant. 
- *or*
- The odds of being diagnosed at *stages IV and III* is 0.973 times the odds of being diagnosed at *stages I and II* with each one-year increase in age, holding all other variables constant. 
- *or*
- The odds of being diagnosed at *stages IV to II* is 0.973 times the odds of being diagnosed at *stage I* with each one-year increase in age, holding all other variables constant. 

##Interpretations 

- *Categorical variable*
- The odds of being diagnosed at stage IV are 0.450 times the odds of being diagnosed at *stages III to I* for patients with private insurance than those without insurance at diagnosis, holding all other variables constant.
- *or*
- The odds of being diagnosed at *stages IV and III* are 0.450 times the odds of being diagnosed at *stages II and I* for patients with private insurance than those without insurance at diagnosis, holding other variables constant. 
- *or*
- The odds of being diagnosed at *stages IV to II* are 0.450 times the odds of being diagnosed at *stage I* for patients with private insurance than those without insurance at diagnosis, holding other variables constant. 
